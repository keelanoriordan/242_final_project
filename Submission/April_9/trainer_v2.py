...
class DenseNet_2block(nn.Module):
    def __init__(self, growth_rate=32, block_config=(6, 12), num_init_features=3, num_classes=3, drop_rate=0.4, block_connection =[True,True,True,True]):
...
class MLP(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.fc1 = nn.Linear(3*80*80, 512)
...
if __name__ == "__main__":
    ...
    blcs = [True, True, True, True] # block connection
