...
if __name__ == "__main__":
    ...
    #### Save Files ####
    results_dir = '/Users/keelanoriordan/Desktop/GitHub_MacStu.nosync/242-Final-Project/DATASET/sr_DN_sup4'
    ...
    b_config = (10, 10, 14, 24)
    gr = 32
    dr = 0.4
    model = DenseNet(growth_rate=gr, block_config=b_config, drop_rate=dr, num_init_features=3, num_classes=3, block_connection=blcs)

    param = {"model":model, "opt_method": "adam", "learning_rate":1e-3, "batch_size":64, "epoch":1000, "l2":1e-4, "block_connection":blcs, "b_config":b_config, "growth_rate":gr, "drop_rate":dr}
    t_params = {"model":model, "opt_method": "adam", "learning_rate":1e-3, "batch_size":64, "epoch":100, "l2":1e-4}
    num_folds = 5
    ...
    with open(model_params_path, 'w') as f:
        ...
        f.write(f"Model Hyperparameters: Optimizer = {param["opt_method"]}, Learning Rate = {param["learning_rate"]}, Batch Size = {param["batch_size"]}, epoch = {param["epoch"]}, l2 norm = {param["l2"]}, block connection = {param["block_connection"]}, block configuration = {param['b_config']}, Growth Rate = {param['growth_rate']}, Drop Rate = {param["drop_rate"]}\n")
    ...
    #     f.write("KFold,Best_Train_Acc,Best_Val_Acc\n")
    # KFoldCrossValidation(num_folds, X_train, y_train, X_test, y_test, results_path, **t_params)